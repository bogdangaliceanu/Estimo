...
namespace Estimo.Tests
{
    public class GameTests
    {
        ...
        public void CanStartNewRound()
        {
            ...
            Assert.IsType<Success>(game.NewRound(subject, player));
        ...
        public void CanFinishCurrentRound()
        {
            ...
            Assert.IsType<Success>(game.FinishCurrentRound(EstimationValue.One, player));

            var round = game.Rounds.Single();
            Assert.True(round.FinishedAt.HasValue);
        }
        ...
        public void CannotStartNewRoundWhenOneIsInProgress()
        {
            ...
            Assert.IsType<Failure<string>>(game.NewRound("s2", player));
        }
        ...
        public void CannotEstimateWithoutARoundInProgress()
        {
            ...
            Assert.IsType<Failure<string>>(game.Estimate(new Estimation(EstimationValue.One, player)));
        }
        ...
        public void CannotFinishARoundWithoutARoundInProgress()
        {
            ...
            Assert.IsType<Failure<string>>(game.FinishCurrentRound(EstimationValue.One, player));
        }
